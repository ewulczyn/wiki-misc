...
def expected_results_by_lift(TestClass, params, iters, p_hat, lifts, fig_name=None):
    ...
    ax1.plot(lifts, p_A_betters['mean'], label='P(A better) median')
    ax1.plot(lifts, p_A_betters['lower'], label='P(A better) lower', alpha=0.31)
    ax1.plot(lifts, p_A_betters['upper'], label='P(A better) upper', alpha=0.31)
